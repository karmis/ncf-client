    ...
    _.extend(bbGrid.View.prototype, Backbone.View.prototype, {
        ...
        toggleSubgridRow: function (model, $el, options) {
            ...
            if (View.$subgridContainer) {
                $('td.bbGrid-subgrid-control i', View.$subgridContainer.prev()).removeClass('fa-minus');
            ...
            $('td.bbGrid-subgrid-control i', $el).addClass('fa-minus');
        ...
        template: _.template(
            ...
            <%} if (isContainSubgrid) {%>\
                <td class="bbGrid-subgrid-control">\
                    <i class="fa fa-plus<%if (isSelected) {%> "fa fa-minus"<%}%>">\
                </td>\
            ...
            '<div class="span bbGrid-pager">\
                <ul class="nav nav-pills">\
                    <li<%if (page === 1) {%> class="active"<%}%>>\
                        <a class="first"><i class="fa-1 fa fa-fast-backward"/></a>\
                    </li>\
                    <li <%if (page === 1) {%> class="active"<%}%>>\
                        <a class="left"><i class="fa-1 fa fa-backward"/></a>\
                    </li>\
                    <li>\
                    ...
                    <li<%if (page === cntpages) {%> class="active"<%}%>>\
                        <a class="right"><i class="fa-1 fa fa-forward"/></a>\
                    </li>\
                    <li<%if (page === cntpages) {%> class="active"<%}%>>\
                        <a class="last"><i class="fa-1 fa fa-fast-forward"/></a>\
                    </li>\
                </ul>\
                </div>\
            <% if (rowlist) {%>\
